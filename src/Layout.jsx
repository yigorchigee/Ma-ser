        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-24">
            <Link to={createPageUrl('Dashboard')} className="flex items-center gap-4">
              <TzedakaLogo className="h-28 md:h-32 aspect-square max-w-[24rem] shrink-0 transition-transform duration-200 hover:-translate-y-0.5 active:scale-95 shadow-sm" />
            </Link>
