        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-32">
            <Link to={createPageUrl('Dashboard')} className="flex items-center gap-4">
              <div className="relative h-28 md:h-32 w-36 md:w-44 overflow-hidden rounded-2xl bg-white/60 border border-white/70 shadow-sm flex items-center">
                <TzedakaLogo className="h-40 md:h-44 w-full object-cover object-top transition-transform duration-200 hover:-translate-y-0.5 active:scale-95" />
              </div>
            </Link>
