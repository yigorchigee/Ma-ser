      ...
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-slate-900 via-slate-800 to-indigo-900 text-white shadow-2xl">
        ...
        <div className="p-8 lg:p-10 flex flex-col gap-6 relative">
          ...
          <div className="grid grid-cols-1 gap-5">
            <div className="rounded-3xl bg-gradient-to-br from-rose-500 via-red-500 to-orange-400 text-white shadow-2xl p-8 relative overflow-hidden">
              ...
              <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6 relative">
                <div className="space-y-4">
                  ...
                  <p className="text-white/90 max-w-xl">Set aside this amount to stay square with your ma'aser goal.</p>
        ...
        <Card className="border border-slate-200 shadow-xl shadow-slate-900/5">
          <CardContent className="p-6 md:p-8 space-y-5">
            <div className="flex items-center justify-between gap-4">
              ...
              <Button
                className="hidden md:inline-flex bg-slate-900 text-white hover:bg-slate-800 active:scale-95"
            ...
            <Button
              className="md:hidden w-full bg-slate-900 text-white hover:bg-slate-800 active:scale-95"
              onClick={() => setShowTransactionForm(false)}
            >
              Close
            </Button>
        ...
        <CardContent className="p-6 md:p-8 space-y-5">
          <div className="flex items-center justify-between gap-4">
            <div className="space-y-1">
              ...
              <h2 className="text-2xl font-bold text-slate-900">Latest income and ma'aser payments</h2>
              <p className="text-sm text-slate-600">Reverse-chronological timeline of everything you're tracking.</p>
            </div>
            <div className="rounded-full bg-indigo-50 text-indigo-700 px-3 py-1 text-xs font-semibold border border-indigo-100">
              Auto-sorted newest first
            </div>
          </div>
          <div className="space-y-3">
            {recentActivity.length === 0 ? (
              <p className="text-center text-slate-600 py-12">No activity yet</p>
            ) : (
              recentActivity.map((item) => (
                <div
                  key={item.id}
                  className={`flex items-center justify-between gap-4 p-4 rounded-2xl border transition hover:-translate-y-0.5 hover:shadow ${
                    item.type === 'income'
                ...
                >
                  <div className="flex items-center gap-4 flex-1 min-w-0">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sm text-slate-600 truncate">{item.account || 'No account info'}</p>
                    </div>
                  </div>
