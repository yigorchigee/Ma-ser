...
If you just want a verbal “do this now” checklist, follow these four commands and open the link it prints:

1. Clone the repo: `git clone <repo-url> && cd Ma-ser`
2. Install dependencies: `npm install`
3. Start the dev server: `npm run dev`
4. Open the printed localhost URL in your browser. Resize the window or use devtools device mode to see the phone view.
